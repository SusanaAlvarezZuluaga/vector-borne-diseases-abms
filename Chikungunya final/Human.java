...
public class Human {
	...
	LogNormalDistribution distTiempoIncubacion = new LogNormalDistribution(1.099, 0.139);//alpha y beta 
	...
	UniformRealDistribution distTiempoInfeccion = new UniformRealDistribution(3, 7);// media 6 desv 1
