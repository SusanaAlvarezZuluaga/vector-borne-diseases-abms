...
public class Human {
	...
	WeibullDistribution distTiempoIncubacion = new WeibullDistribution(2.69, 6.70);//alpha y beta 
	...
	NormalDistribution distTiempoInfeccion = new NormalDistribution(6, 1);// media 6 desv 1
